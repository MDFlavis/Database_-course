...
INSERT INTO `accounts` VALUES (1,'iVAN229','LKJADHFK431'),(2,'NA9IBA70R','AJSHKD23'),(3,'pOL-LEGA','QWERTY123'),(4,'MINECRAFT-LOWER','228JKJASHD'),(5,'HOLOLIVE5THGEN','PEKOPEKOPEKO');
...
INSERT INTO `products` VALUES (1,'Intel Core i3-8100','Процессор для настольных персональных компьютеров, основанных на платформе Intel.',7890.00,1,'2021-01-25 20:17:34','2021-01-25 20:17:34'),(2,'Intel Core i5-7400','Процессор для настольных персональных компьютеров, основанных на платформе Intel.',12700.00,1,'2021-01-25 20:17:34','2021-01-25 20:17:34'),(3,'AMD FX-8320E','Процессор для настольных персональных компьютеров, основанных на платформе AMD.',4780.00,1,'2021-01-25 20:17:34','2021-01-25 20:17:34'),(4,'AMD FX-8320','Процессор для настольных персональных компьютеров, основанных на платформе AMD.',7120.00,1,'2021-01-25 20:17:34','2021-01-25 20:17:34'),(5,'ASUS ROG MAXIMUS X HERO','Материнская плата ASUS ROG MAXIMUS X HERO, Z370, Socket 1151-V2, DDR4, ATX',19310.00,2,'2021-01-25 20:17:34','2021-01-25 20:17:34'),(6,'Gigabyte H310M S2H','Материнская плата Gigabyte H310M S2H, H310, Socket 1151-V2, DDR4, mATX',4790.00,2,'2021-01-25 20:17:34','2021-01-25 20:17:34'),(7,'MSI B250M GAMING PRO','Материнская плата MSI B250M GAMING PRO, B250, Socket 1151, DDR4, mATX',5060.00,2,'2021-01-25 20:17:34','2021-01-25 20:17:34');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `product_insert_null_check` BEFORE INSERT ON `products` FOR EACH ROW BEGIN 
...
INSERT INTO `task_3` VALUES ('2018-08-01'),('2018-08-04'),('2018-08-16'),('2018-08-17');
...
LOCK TABLES `task_4` WRITE;
/*!40000 ALTER TABLE `task_4` DISABLE KEYS */;
INSERT INTO `task_4` VALUES ('2018-08-27'),('2018-08-28'),('2018-08-29'),('2018-08-30'),('2018-08-31');
/*!40000 ALTER TABLE `task_4` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `users` VALUES (2,'Наталья','1984-11-12','2021-01-25 20:17:34','2021-01-25 20:17:34'),(3,'Александр','1985-05-20','2021-01-25 20:17:34','2021-01-25 20:17:34'),(4,'Сергей','1988-02-14','2021-01-25 20:17:34','2021-01-25 20:17:34'),(5,'Иван','1998-01-12','2021-01-25 20:17:34','2021-01-25 20:17:34'),(6,'Мария','1992-08-29','2021-01-25 20:17:34','2021-01-25 20:17:34');
...
/*!50001 VIEW `name` AS select `products`.`name` AS `product`,`catalogs`.`name` AS `catalog` from (`products` left join `catalogs` on((`products`.`catalog_id` = `catalogs`.`id`))) */;
...
-- Dump completed on 2021-02-01 13:40:07
